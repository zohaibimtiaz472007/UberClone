      ...
      <div className="fixed left-0 top-0 bottom-0 w-80 bg-white z-50 shadow-2xl animate-slideRight overflow-y-auto">
        ...
        <div className="p-6">
          <div className="space-y-4">
            <MenuItem icon="📊" label="Earnings Report" subtitle="View detailed earnings" />
            <MenuItem icon="📅" label="Trip History" subtitle="View your past rides" />
            <MenuItem icon="⚙️" label="Settings" subtitle="Account & preferences" />
            <MenuItem icon="❓" label="Help & Support" subtitle="24/7 customer support" />
            <MenuItem icon="📜" label="Terms & Policies" subtitle="Legal information" />
            ...
            >
              ...
              <div className="text-left">
                <p className="font-medium text-gray-900">{isOnline ? 'Go Offline' : 'Go Online'}</p>
                <p className="text-xs text-gray-500">Toggle ride availability</p>
              </div>
            </button>
        ...
        <div className="absolute bottom-0 left-0 right-0 p-6 border-t border-gray-100 bg-gray-50">
          <div className="flex items-center gap-3">
            ...
            <div>
              ...
              <p className="text-xs text-gray-500">Captain ID: CAP123456</p>
